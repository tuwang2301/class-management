...
<html>
    ...
    <body>
        ...
        <div class='whole-body'>
            ...
            <form class='info-form' action="updateTeacher" method=<%=method%>>
                <p>ID: <input type="text" name="id" value="<%= t.getId()%>" readonly /> 
                <p>Name: <input type="text" name="name" value="<%= t.getName() %>"/> 
                <p>Email: <input type="text" name="email" value="<%= t.getEmail() %>"/> 
