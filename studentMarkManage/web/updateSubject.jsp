...
<html>
    ...
    <body>
        ...
        <form class="info-form" action="updateSubject" method="POST">
            <p>ID: <input type="text" name="id" value="<%= s.getId()%>" readonly /> 
            <p>Teacher ID: <input type="text" name="tid" value="<%= s.getTeacher().getId() %>"/> 
            <p>Name: <input type="text" name="name" value="<%= s.getName() %>"/> 
